...
const Navbar = () => {
    const [MobileNavHandler, setMobileNavHandler] = useState(false)
  return (
    <div className="px-3 py-4 bg-[#f1f1f1] sticky top-0 border-b-[#dbdcdc] border-b-[1px] z-50">
      <div className="flex justify-between items-center">
        ...
        <div className="md:hidden block">
          <button className="btn btn-outline" onClick={()=>{setMobileNavHandler((prev)=>{return !prev})}}>
            <svg
      ...
      {
        MobileNavHandler && <MobileNav setMobileNavHandler={setMobileNavHandler} />
      }
</div>
  );
};
